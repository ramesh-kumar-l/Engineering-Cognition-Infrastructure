...
PY := uv run
PYTHON_PKGS := apps/api packages/observability packages/storage packages/ingest packages/llm packages/compression packages/retrieval packages/execution packages/reflection packages/identity
